...
Service.prototype.discoverIncludedServices = function(includedServiceUUIDs) {
...
Service.prototype.onIncludedServicesDiscover = function(error) {
  ...
  if (error === undefined) {
    ...
    $util.$arrayForEach($includedServices, function($includedService) {
      var includedService        = new Service($includedService);
...
Service.prototype.onCharacteristicsDiscover = function(error) {
